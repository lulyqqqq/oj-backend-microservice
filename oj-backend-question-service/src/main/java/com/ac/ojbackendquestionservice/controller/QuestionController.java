package com.ac.ojbackendquestionservice.controller;

import com.ac.model.dto.question.*;
...
import com.ac.ojbackendcommon.annotation.AuthCheck;
import com.ac.ojbackendcommon.common.BaseResponse;
import com.ac.ojbackendcommon.common.DeleteRequest;
import com.ac.ojbackendcommon.common.ErrorCode;
import com.ac.ojbackendcommon.common.ResultUtils;
import com.ac.ojbackendcommon.constant.UserConstant;
import com.ac.ojbackendcommon.exception.BusinessException;
import com.ac.ojbackendcommon.exception.ThrowUtils;
...
public class QuestionController {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        if (!question.getUserId().equals(loginUser.getId()) && !userFeignClient.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "没有权限访问");
        }
...
//        }
    ...
    /**
     * 分页获取题目的提交列表(除了管理员外，普通用户只能看到非答案,提交代码等公开信息)
     *
